...
export const Sectionsix = () => {
   return (
      <div className="max-w-screen-xl m-auto px-[5%] max-[1000px]:py-12 py-24 ">
            ...
            <div className="w-[50%] max-[1000px]:w-[100%] mx-auto max-[1000px]:max-w-[550px] max-[1000px]:mb-8">
               <div className="h-full flex flex-col">
                  <div className="shadow-md h-full rounded-2xl bg-[#ededed] relative">
                     ...
                     <div className="font-heading text-[30px] self-center font-bold py-3 text-center leading-9">
                        Over 33 Years of <br />
                        Real Estate Success
                     </div>
                     <div className="font-text  bg-[#ededed] p-5 pt-0 rounded-b-2xl">
            ...
            <div className="w-[50%] max-[1000px]:w-[100%] max-[1000px]:max-w-[550px] mx-auto">
               <div className="h-full flex flex-col">
                  <div className="shadow-md rounded-2xl bg-[#ededed] h-full">
                     ...
                     <div className="font-heading text-[30px] font-bold text-center py-3 px-5 leading-9">
